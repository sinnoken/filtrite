...
| [Taiwan](https://github.com/sinnoken/filtrite/releases/latest/download/taiwan.dat) | The "Bromite Extended" list with additional region-specific blocklists for taiwan sites |
